...
the static files to the **`gh-pages`** branch of this repo using an SSH deploy
key. The `main` branch holds only this note.
...
See `SETUP.md` in `private-repo-cicd` for the one-time deploy-key setup.
